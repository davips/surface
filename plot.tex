...
\begin{document}
    ...
    \newcount\tmp\tmp=1\loop\advance\tmp by 1\def\fim{11}
...
%            \addplot [each nth point={\pula}, no marks, black!30!green, dashed, thick] table [header=false, x expr={\thisrowno{1}/3600000}, y index = {2}] {\f-\seed-\grid-\budget-\b.log};
            ...
            \addplot [each nth point={\pula}, mark=*, mark repeat=10, mark options={solid}, black!30!green] table [header=false, x expr=\coordindex, y index = {2}] {\f-\seed-\gridc-\budget-\c.log}; \label{c}
        ...
        \begin{axis}[legend style={at={(0.5,1.5)},anchor=north}, skip coords between index={0}{1}, axis y line*=right, axis x line=none, ylabel=Error] %, legend style={at={(0.5,1.05)},anchor=south}]
            ...
            \addplot [each nth point={\pula}, mark=*, mark repeat=10, mark options={solid}, black!30!green, dotted, thick] table [header=false, x expr=\coordindex, y index = {3}] {\f-\seed-\gridc-\budget-\c.log}; \addlegendentry{\cname error}
